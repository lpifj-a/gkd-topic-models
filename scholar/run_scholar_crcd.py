...
from scholar_crcd import Scholar
...
def main(call=None):
    ...
    parser.add_argument(
        "--fkd-output-emb-dim",
        dest = "fkd_output_emb_dim",
        type=int,
        default=None,
        help="The dimension of the transformation matrices used to transform the student and teacher dimensions. If it is None, no transformation matrix is used (same as the identity matrix)",
    )
    parser.add_argument(
        "--FKD-loss-function",
...
def make_network(
    ...
    network_architecture = dict(
        ...
        rcd_n_data = rcd_n_data,
        fkd_teacher_emb_dim=fkd_teacher_emb_dim,
        fkd_output_emb_dim=options.fkd_output_emb_dim,
        fkd_n_data = fkd_n_data,
