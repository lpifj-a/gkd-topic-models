...
from run_scholar_crcd import main
...
if __name__ == "__main__":
    ...
    print(outdir_args.o)
    print(Path(outdir_args.o, "run_scholar_crcd.py"))
    # copy over code
    Path(outdir_args.o).mkdir(parents=True, exist_ok=True)
    shutil.copy("./scholar/run_scholar_crcd.py", Path(outdir_args.o, "run_scholar_crcd.py"))
    shutil.copy("./scholar/scholar_crcd.py", Path(outdir_args.o, "scholar_crcd.py"))
    ...
    for run in range(run_args.runs):
        ...
        ## test
        test_counts = fh.load_sparse(run_args.test_counts_fpath)
        test_vocab = fh.read_json(run_args.test_vocab_fpath)
        ...
        results = pd.DataFrame({
            ...
            #     ),
               'npmi_test_value': compute_npmi_at_n(
                   topics, test_vocab, test_counts.tocsc(), n=run_args.npmi_words, silent=False,
                ),
